  ...
  function showBanner() {
    ...
    banner.innerHTML = `
      <div class="consent-copy">
        ...
        <p>Mit Ihrer Einwilligung verwenden wir Google Analytics für die Nutzungsanalyse des Atlas. Der Google-Tag wird erst nach Ihrer Zustimmung geladen. <a href="${privacyUrl}">Mehr erfahren</a></p>
      </div>

  ...
  function showBanner() {
    ...
    banner.innerHTML = `
      <div class="consent-copy">
        ...
        <p>Mit Ihrer Einwilligung verwenden wir Google Analytics, um die Nutzung des Atlas zu verstehen. Ohne Zustimmung wird der Google-Tag nicht geladen. <a href="${privacyUrl}">Mehr erfahren</a></p>
      </div>
